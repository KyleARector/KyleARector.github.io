...
categories: []
---
<p>First official post on my new blog! I hope to use this site to learn, give tips on various CAD or coding issues, and share some of my projects. As I mention on the "About" page, I am a heavy CAD user, with specialties in CATIA V5, Creo 2.0, and NX. I am also a developer, and like to work with C# and WPF or C++ and gesture peripheral APIs. I occasionally work in VB.NET, but typically prefer fully compiled languages, when given the choice.<br/><br/>
...
<ul>
	...
	<li>Been able to manipulate Jekyll to populate this site</li>
