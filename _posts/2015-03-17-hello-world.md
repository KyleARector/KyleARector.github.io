...
<ul>
	<li>A. Been able to develop my first web site several years ago in HTML and CSS</li>
	<li>B. Been able to build this site with a blog using Jekyll (Thanks Matt!)</li>
	<li>C. Made it through college, in general</li>
<ul>
</p>
